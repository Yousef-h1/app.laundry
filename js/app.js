...
(function (window) {
    ...
    function printCss() {
        return `
            @page{size:58mm auto;margin:0}
            *{-webkit-print-color-adjust:exact;print-color-adjust:exact}
            body{font-family:'Segoe UI',Tahoma,Arial,sans-serif;width:48mm;margin:0 auto;padding:2mm 0;color:#111;background:#fff;font-size:13px}
            .inv{width:100%}
            .header{text-align:center;border-bottom:1.5px solid #000;padding-bottom:2mm;margin-bottom:2mm}
            .shop{font-size:16px;font-weight:800;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
            .sub{font-size:11px;color:#333}
            .meta{display:flex;justify-content:space-between;font-size:12px;padding:1.5mm 0;border-bottom:1px dashed #999}
            table{width:100%;margin-top:2mm;font-size:12px;border-collapse:collapse;border-top:1px solid #333}
            thead th{background:#eee;font-size:11px;padding:1mm 0}
            tbody td{border-bottom:1px solid #ddd;padding:1mm 0}
            .totals{margin-top:2mm;text-align:right;font-size:13px}
            .totals > div{margin-bottom:1mm}
            .tax{font-size:12px;color:#475569}
            .grand{background:#000;color:#fff;font-weight:800;padding:1.5mm;font-size:15px}
            .footer{text-align:center;margin-top:3mm;font-size:12px;color:#555}
