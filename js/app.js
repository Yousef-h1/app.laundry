...
(function (window) {
    ...
    function posSug() {
        ...
        if (!App._posSugBound) {
            ...
            App._posEscFn = (ev) => { if (ev.key === 'Escape') { App.posHideSug(); App._posSugBound = false; document.removeEventListener('click', App._posClickFn); document.removeEventListener('keydown', App._posEscFn); } };
    ...
    function posSugOutside(ev) {
        const box = document.getElementById('posSug');
        if (!box || box.style.display === 'none') { App._posSugBound = false; document.removeEventListener('click', App._posClickFn); document.removeEventListener('keydown', App._posEscFn); return; }
        const t = ev.target;
